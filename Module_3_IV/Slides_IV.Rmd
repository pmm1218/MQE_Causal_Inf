...
It is also a rare, (some may argue imaginary) beast, that often turns out to be a horse with an overly optimistic rider (author).
...
#note: we can test this covariance because I am working with simulated data and observe x_2.
...
\centering![]("images\badass-unicorn-emma-sondergaard.jpg")
...
$\Rightarrow Z_i$ is a valid instrument for $D_i$ and the IV estimator gives us a consistent estimate of $\tau$, the effect of taking the pill on blood pressure. 
...
We want to know the effect of taking the pill. 
...
- the IV is different from simply taking the mean of $Y_i$ for those in the treatment group who took the pill and subtracting the mean of $y_i$ for those in the control group who did not take the pill. 
