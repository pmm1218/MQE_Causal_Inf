...
Suppose you are interested in heterogenous effects on Y of treatment D based on characteristic X. Write the estimating equation you should use (you can use B nistead of $\Beta$)
...
## Alphabet Soup!:IV's and RCT's from ITT to TOT
...
- The TOT:  the effect of the treatment on those who actually got treated. 

We can recover the TOT estimates using an IV estimation where being treated is instrumented  by being in the treatment group (see the IV Module Notes).  
...
## ITT and TOT: Contraceptive choice
