...
4. Verify the new upstream repository you've specified for your fork.
    ...
    `$ git remote -v `
      ...
      `> upstream  https://github.com/YOUR_USERNAME/YOUR_FORK.git (fetch)`
...
Note: Git may send you to a weird window asking you to write a commit message. You can escape this with `Shift+:` followed by Q. 



# Group work in a Public Repository (Problem Set 1)
...
# Group work in a Private Repository (Problem Sets 2+)
